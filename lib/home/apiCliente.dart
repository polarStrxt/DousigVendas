...
class ClienteService {
  static const String baseUrl = "http://duotecsuprilev.ddns.com.br:8082/v1/cliente/001/31.01.1980";

  /// 🔹 Busca um único cliente por ID e data de nascimento
  static Future<Cliente?> buscarCliente(String id, String dataNascimento) async {
    try {
